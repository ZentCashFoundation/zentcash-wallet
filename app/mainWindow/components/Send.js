...
export default class Send extends Component<Props, State> {
    ...
    constructor(props?: Props) {
        ...
        this.handleSendToAddressChange = this.handleSendToAddressChange.bind(
            this
        );
    ...
    componentDidMount() {
        eventEmitter.on(
            ...
            this.handleTransactionInProgress
        );
                ...
                const modalMessage = (
                    <div>
                        ...
                        <p className={`subtitle ${textColor}`}>
                            ...
                            <br />
                            {atomicToHuman(amount + nodeFee + txFee, true)}{" "}
                            {Configure.ticker}
                        </p>
                        <p className={`subtitle ${textColor}`}>
                            <b>Fee:</b>
                            <br />
                            {atomicToHuman(nodeFee + txFee, true)}{" "}
                            {Configure.ticker}
                            {nodeFee > 0 &&
        ...
        if (!sufficientFunds) {
            ...
            const message = (
                <div>
                    ...
                    <br />
                    <p className={`subtitle ${textColor}`}>
                        The transaction was not successful. You don&apos;t have
                        enough funds!
                    </p>
                </div>
            );
        ...
        if (!sufficientUnlockedFunds) {
            const message = (
                <div>
                    ...
                    <p className={`subtitle ${textColor}`}>
                        You don&apos;t have enough unlocked funds! Wait until
                        your funds unlock then try again.
                    </p>
                </div>
            );
    ...
    render() {
        ...
        const addressInput = (
            ...
            >
                <Creatable
                    ...
                    placeholder="Enter a Zent Cash address or a contact name to send funds to"
        ...
        return (
            <div>
                <Redirector />
                <div
                    className={`wholescreen ${backgroundColor}  hide-scrollbar`}
                >
                    <ReactTooltip
                        effect="solid"
                        type={toolTipColor}
                    ...
                    <div
                        className={`maincontent ${backgroundColor} ${pageAnimationIn}`}
                    >
                                ...
                                >
                                    ...
                                    <div className="control">
                                        <input
                                            ...
                                            type="text"
                                            placeholder={
                                                il8n.send_to_address_input_placeholder
                                            }
                                            value={sendToAddress}
                                            onChange={
                                                this.handleSendToAddressChange
                                            }
                                            id="address"
                                        />
                                    </div>
                                ...
                                >
                                    ...
                                    <div className="control">
                                        <input
                                            ...
                                            type="text"
                                            placeholder={
                                                il8n.payment_id_input_placeholder
                                            }
                                            value={paymentID}
                                            onChange={
                                                this.handlePaymentIDChange
                                            }
                                            id="paymentid"
                                        />
                                        <a
