            ...
            },
            {
                ...
                submenu: [
                    ...
                    submenu: [
                      {
                        ...
                        submenu: [
                          {
                            label: 'Zent Cash Wallet (Official)',
                            click: () => {
                              shell.openExternal(
                                'https://github.com/ZentCashFoundation/zentcash-wallet/releases'
                              );
                            }
                          },
                          {
                            label: 'Zent Cash Electronic Wallet (Official)',
                            click: () => {
                              shell.openExternal(
                                'https://github.com/ZentCashFoundation/zentcash-wallet-electronic/releases'
                              );
                            }
                          }
                        ]
                      },
                      {
                        ...
                        submenu: [
                          {
                            label: 'Zent Cash Wallet Mobile - Android (Official)',
                            click: () => {
                              shell.openExternal(
                                'https://play.google.com/store/apps/details?id=cash.zent.mobileapp'
                              );
                            }
                          },
                          {
                            label: 'Zent Cash Wallet Mobile - iOS (Official)',
                            click: () => {
                              shell.openExternal(
                                'https://play.google.com/store/apps/details?id=cash.zent.mobileapp'
                              );
                      ...
                      },
                      {
                        ...
                        submenu: [
                          {
                            label: 'Zent Cash Web Wallet (Official)',
                            click: () => {
                              shell.openExternal(
                                'https://webwallet.zent.cash/'
                              );
                            }
                          }
                        ]
                      ...
                      },
                      {
                        ...
                        submenu: [
                          {
                            label: 'Zent Cash Paper Wallet Generator (Official)',
                            click: () => {
                              shell.openExternal(
                    ...
                    submenu: [
                      {
                        ...
                        click: () => {
                          shell.openExternal(
                            'https://www.finexbox.com/Orders/market/pair/ZTC-BTC.html'
                          );
                        }
                      }
                    ]
                  ...
                  },
                  {
                    ...
                    submenu: [
                      {
                        label: 'Zent Cash Pool (Finland)',
                        click: () => {
                          shell.openExternal(
                            'https://pool.zent.cash/'
                          );
                        }
                      },
                      {
                      ...
                      {
                        label: 'SemiPool (Hong Kong)',
                        click: () => {
                          shell.openExternal(
                            'https://webztc.semipool.com/#/dashboard'
                          );
                        }
                      }
                    ]
                    ...
                    submenu: [
                      {
                        ...
                        click: () => {
                          shell.openExternal(
                            'https://www.facebook.com/zent.cash.1'
                          );
                        }
                      },
                      {
                      ...
                      },
                      {
                        ...
                        click: () => {
                          shell.openExternal(
                            'https://discord.com/invite/9s7jWXF'
                          );
                        }
                      },
                      {
